...
if __name__ == '__main__':
    ...
    parser.add_argument('--case', required=True, choices=['atari', 'vgdl'],
    ...
    parser.add_argument('--object_store_memory', type=int, default=150 * 1024 * 1024, help='object store memory')
    ...
    if args.case == 'atari':
        ...
        from config.vgdl import game_config
    else:
